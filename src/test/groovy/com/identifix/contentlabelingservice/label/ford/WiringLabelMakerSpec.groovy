...
class WiringLabelMakerSpec extends Specification {
    WiringLabelMaker systemUnderTest
    ...
    void setup() {
        systemUnderTest = new WiringLabelMaker().with {
    ...
    def 'handleMessage' () {
        ...
        Manual manual = new Manual().with {
            publisherManualCategory = 'wiring'
            manualId = 'test'
            it
        }
        when:
        ...
        then:
            ...
            1 * mockKrakenClient.buildWiringLabelingCsv(_, _, _) >> labels
