...
class WorkshopLabelMakerSpec extends Specification {
    WorkshopLabelMaker systemUnderTest
    ...
    String labels = 'Label,title,tocpath,category,linkToPage,nuxeoId\n' +
            ',GENERAL INFORMATION; 2013 - 2018 MY RAV4 [12/2012 - ], General > INTRODUCTION > INTRODUCTION > HOW TO USE THIS MANUAL > GENERAL INFORMATION; 2013 - 2018 MY RAV4 [12/2012 - ], Repair Manual, toyota-crawler-bucket/qa/unzipped/TOYOTA/2013/RM/13-18RAV4_RM30B0U_EN_20-08-10_HTML/RM30B0U/xhtml/RM10000000050E6.html, ec7c3da1-7832-311c-8525-0754a38eef0e\n' +
            ',VEHICLE IDENTIFICATION AND SERIAL NUMBERS; 2013 - 2018 MY RAV4 [12/2012 - ], General > INTRODUCTION > INTRODUCTION > IDENTIFICATION INFORMATION > VEHICLE IDENTIFICATION AND SERIAL NUMBERS; 2013 - 2018 MY RAV4 [12/2012 - ], Repair Manual, toyota-crawler-bucket/qa/unzipped/TOYOTA/2013/RM/13-18RAV4_RM30B0U_EN_20-08-10_HTML/RM30B0U/xhtml/RM10000000050TD.html, 53e11ac3-8b5a-35bb-bcd4-fe57b5328189'

    void setup() {
        systemUnderTest = new WorkshopLabelMaker().with {
    ...
    def 'handleMessage' () {
        FordWorkshopMessage message = new FordWorkshopMessage().with {
            year = 'test'
            model = 'test'
            it
        }
        ...
        then:
            ...
            1 * mockKrakenClient.buildWorkshopLabelingCsv(_, _) >> labels
